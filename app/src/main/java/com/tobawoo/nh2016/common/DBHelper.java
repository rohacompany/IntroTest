...
import com.tobawoo.nh2016.data.Zipcode;
...
public class DBHelper {
    ...
    public List<String> fetchSido(){
        ...
        sidoList.add(mCtx.getResources().getString(R.string.all));
    ...
    public void fetchGuGun(String sido , List<String> gugunList){
        ...
        gugunList.add(mCtx.getResources().getString(R.string.all));
    ...
    public void fetchDong(String sido , String gugun ,  List<String> dongList){
        ...
        dongList.add(mCtx.getResources().getString(R.string.all));
