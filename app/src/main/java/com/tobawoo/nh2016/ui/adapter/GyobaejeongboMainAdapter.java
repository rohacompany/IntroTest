 ...
 */
public class GyobaejeongboMainAdapter<T> extends SampleTableAdapter{
    ...
    public GyobaejeongboMainAdapter(Context context, List<CommonTableData> tabList , CommonResultType nonggaType) {
        super(context);
...
//        }
    ...
    private View getHeader(int row, int column, View convertView, ViewGroup parent) {
        ...
        if((column >=1 && column <=3) ||  (column >=8 && column <= 13)){
        ...
        if((column >=1 && column <=3) || (column >=8 && column <= 13) ){
            ...
            if(column == 3 || column==9 || column == 11 || column == 13){
...
//        Logger.log("getBody end ==========");
    ...
    public String getCellString(int row, int column) {
        String data = "";
        GyobaejeongboResultData resultData = getDevice(row);
        switch (column){
            case 0:
            ...
            case 9:
                ...
                break;
            case 10:
                data = resultData.getCrossbreed_dt();
                break;
            case 11:
                data = resultData.getKpn_no();
                break;
            case 16:
                data = resultData.getBreed_schedule_dt();
                break;
            case 17:
                data = resultData.getBreed_dt();
                break;
            case 18:
                data = resultData.getFertilization_charge();
                break;
            case 20:
                data = resultData.getFarm_addr();
                break;
            case 21:
                data = resultData.getFarm_phone();
                break;
            case 22:
                data = resultData.getFarm_mobile();
                break;
//            case 1:
//                data = resultData
        }
    ...
    private GyobaejeongboResultData getDevice(int row) {

        return (GyobaejeongboResultData) nonggaType.get(row);
    }
