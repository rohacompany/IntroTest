...
public class GyobaejeongboSearchActivity extends SubBaseActivity implements OnTableItemClickListener {
    ...
    GyobaejeongboData gyobaejeongboData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gyobaejeongboData = (GyobaejeongboData) getIntent().getExtras().getSerializable("data");
    ...
    public void setTableLayout() {
        ...
        final GyobaejeongboMainAdapter<String> matrixTableAdapter = new GyobaejeongboMainAdapter<>(this, CommonFragDatas.getGyobaeHeaderList(), nt);
        matrixTableAdapter.setOnTableItemClick(this);
        tableFixHeaders.setAdapter(matrixTableAdapter);

        CommonUtils.printMap(gyobaejeongboData.getParamMap());

        aq.progress(CommonUtils.getProgressDialog(this)).ajax(URLManager._GET_GYOBAEJEONGBO_LIST, gyobaejeongboData.getParamMap() , JSONObject.class , new AjaxCallback<JSONObject>(){
            @Override
...
//    }
    ...
    public void onListItemClicked(View view,CommonInter commonInter, int row, int column) {
        ...
        final GyobaejeongboResultData gyobaejeongboResultData = (GyobaejeongboResultData) commonInter;
...
//       view.setBackgroundColor(getResources().getColor(R.color.DarkGray));
        ...
        mQuickAction.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
            ...
            public void onItemClick(QuickAction quickAction, int pos, int actionId) {
                ...
                Intent intent = null;
                Bundle bundle = new Bundle();
                bundle.putSerializable("data" , gyobaejeongboResultData);
                switch (actionId){
                    case  CommonUtils.ID_VIEW_SEARCH_GAECHE:
                        intent = new Intent(GyobaejeongboSearchActivity.this , GaecheDetailTabAllActivity.class);
                        intent.putExtra("search_barcode" , gyobaejeongboResultData.getBarcode());
                        break;
                    case CommonUtils.ID_VIEW_DETAIL:
                        intent = new Intent(GyobaejeongboSearchActivity.this , GaecheDetailActivity.class);
                        break;
                }
                if(intent!=null) {
                    intent.putExtras(bundle);
