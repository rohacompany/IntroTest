 ...
 */
public class ChulhaDetailFrag extends Fragment{
    ...
    public void setTableLayout() {
        ...
        final ChulhajeongboMainAdapter<String> matrixTableAdapter = new ChulhajeongboMainAdapter<>(getActivity(), CommonFragDatas.getChulhajeongboHeaderList(), nt);
...
//        Logger.log("분만정보 바코드 -> " + barcode);
        ...
        aq.progress(CommonUtils.getProgressDialog(getActivity())).ajax(URLManager._GET_CHULHAJEONGBO_LIST, paramMap , JSONObject.class , new AjaxCallback<JSONObject>(){
            @Override
