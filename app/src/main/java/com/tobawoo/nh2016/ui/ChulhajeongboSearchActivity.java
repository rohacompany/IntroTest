...
import com.tobawoo.nh2016.ui.adapter.ChulhajeongboMainAdapter;
...
public class ChulhajeongboSearchActivity extends SubBaseActivity implements OnTableItemClickListener {

    CommonResultType nt = null;

    AQuery aq;

    ChulhajeongboData chulhajeongboData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aq.id(R.id.table_result_search_title).text("출하 정보 결과 조회");

        chulhajeongboData = (ChulhajeongboData) getIntent().getExtras().getSerializable("data");
    ...
    public void setTableLayout() {
        ...
        final ChulhajeongboMainAdapter<String> matrixTableAdapter = new ChulhajeongboMainAdapter<>(this, CommonFragDatas.getChulhajeongboHeaderList(), nt);
        matrixTableAdapter.setOnTableItemClick(this);
        tableFixHeaders.setAdapter(matrixTableAdapter);

        aq.progress(CommonUtils.getProgressDialog(this)).ajax(URLManager._GET_CHULHAJEONGBO_LIST, chulhajeongboData.getParamMap() ,  JSONObject.class , new AjaxCallback<JSONObject>(){
            @Override
                ...
                if(object!=null){
                    ...
                    try {
                        ...
                        for(int i=0;i<array.length();i++){
                            ...
                            ChulhajeongboResultData nrd = gson.fromJson(item.toString() , ChulhajeongboResultData.class);
                            nt.list.add(nrd);
...
//    }
    ...
    public void onListItemClicked(View view,CommonInter commonInter, int row, int column) {
        final ChulhajeongboResultData chulhajeongboResultData = (ChulhajeongboResultData) commonInter;
...
//       view.setBackgroundColor(getResources().getColor(R.color.DarkGray));
        ...
        mQuickAction.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
            ...
            public void onItemClick(QuickAction quickAction, int pos, int actionId) {
                ...
                Intent intent = null;
                Bundle bundle = new Bundle();
                bundle.putSerializable("data" , chulhajeongboResultData);
                switch (actionId){
                    case  CommonUtils.ID_VIEW_SEARCH_GAECHE:
                        intent = new Intent(ChulhajeongboSearchActivity.this , GaecheDetailTabAllActivity.class);
                        intent.putExtra("search_barcode" , chulhajeongboResultData.getBarcode());
                        break;
                    case CommonUtils.ID_VIEW_DETAIL:
                        intent = new Intent(ChulhajeongboSearchActivity.this , GaecheDetailActivity.class);
                        break;
                }
                if(intent!=null) {
                    intent.putExtras(bundle);
