...
public class BunmanSummaryFrag1 extends CommonSummaryFrag implements OnChartValueSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.view_frag_bunman_tab1_summary, container, false);
    ...
    public void setChart(){
        ...
        aq.id(R.id.chart_title).text("축협별 분만두수(산차)");

        ArrayList<String> xVals = new ArrayList<String>();

        String[] xTitles = {"1산차" , "2산차" , "3산차" , "4산차" , "5산차" , "6산차이상"};
        ...
        for(int i=0;i<list.size();i++) {
            ...
            yVals1.add(new BarEntry(list.get(i).getBreed_1_cnt(), 0));
            yVals1.add(new BarEntry(list.get(i).getBreed_2_cnt(), 1));
            yVals1.add(new BarEntry(list.get(i).getBreed_3_cnt(), 2));
            yVals1.add(new BarEntry(list.get(i).getBreed_4_cnt(), 3));
            yVals1.add(new BarEntry(list.get(i).getBreed_5_cnt(), 4));
            yVals1.add(new BarEntry(list.get(i).getBreed_over_cnt(), 5));
