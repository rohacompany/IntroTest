...
public class GaecheJungboTabFrag extends Fragment implements View.OnClickListener,StyledAdapter.OnTableItemClick{
    AQuery aq;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.view_search_box_type3, container , false);
        }
