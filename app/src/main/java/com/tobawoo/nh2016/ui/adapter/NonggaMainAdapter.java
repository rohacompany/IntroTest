...
public class NonggaMainAdapter<T> extends SampleTableAdapter{
        ...
        public NonggaMainAdapter(Context context, List<CommonTableData> tabList, CommonResultType nonggaType) {
            super(context);
        ...
        public String getCellString(int row, int column) {
            ...
            switch (column){
                ...
                case 6:
                    ...
                    break;
                case 7:
                    data = nonggaSearchResultData.getHuss_sex_m_cnt() + "";
                    break;
                case 8:
                    data = nonggaSearchResultData.getHuss_sex_f_cnt() + "";
                    break;
                case 9:
                    data = nonggaSearchResultData.getHuss_sex_n_cnt() + "";
                    break;
                case 10:
                    data = nonggaSearchResultData.getHuss_sex_cnt() + "";
                    break;
                case 11:
