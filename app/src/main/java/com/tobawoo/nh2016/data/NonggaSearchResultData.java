 ...
 */
public class NonggaSearchResultData implements CommonInter,Serializable{
    private int idx;
    ...
    private int huss_num;


    private int huss_sex_f_cnt, huss_sex_m_cnt, huss_sex_n_cnt,huss_sex_cnt;
    ...
    public int getHuss_num() {
        return huss_num;
    }

    public void setHuss_num(int huss_num) {
        this.huss_num = huss_num;
    }
