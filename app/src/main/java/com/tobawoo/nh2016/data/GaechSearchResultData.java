 ...
 */
public class GaechSearchResultData implements CommonInter,Serializable{
    ...
    private String conference_addr; //경진대회(주소)
    private String conference_chuju; //축주
    ...
    public String getConference_chuju() {
        return conference_chuju;
    }

    public void setConference_chuju(String conference_chuju) {
        this.conference_chuju = conference_chuju;
    }
    ...
    public String toString() {
        return "GaechSearchResultData{" +
                ...
                ", conference_chuju='" + conference_chuju + '\'' +
