 ...
 */
public class BaseFrag extends Fragment implements DatePickerDialog.OnDateSetListener{
...
//        aq.find(R.id.ibtn_type1_open_date_popup_start).clicked(this, "showDatePicker");
//        aq.find(R.id.ibtn_type1_open_date_popup_end).clicked(this, "showDatePicker");
...
//                targetTextView = R.id.tv_type2_date_popup_start;
//                break;
