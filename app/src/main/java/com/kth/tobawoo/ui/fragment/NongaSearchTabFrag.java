...
public class NongaSearchTabFrag extends Fragment implements View.OnClickListener,StyledAdapter.OnTableItemClick{
    AQuery aq;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Logger.log("NongSearchTabFrag onCreateView");

        if (view == null) {
            view = inflater.inflate(R.layout.view_search_box_type1, container , false);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        Logger.log("NongSearchTabFrag onSaveInstanceState");
    }
