...
public class StyledAdapter<T> extends SampleTableAdapter {
    ...
    public StyledAdapter(Context context , String[] headers , int[] widths , NonggaType nonggaType) {
        super(context);
...
//        }
    ...
    @Override
    public View getView(final int row, int column, final View convertView, ViewGroup parent) {
